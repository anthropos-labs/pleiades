...
//
//	err = os.MkdirAll(fsm.dbPath(false), os.FileMode(fsm2.dbDirModeVal))
...
//	db, err := bbolt.Open(fsm.dbPath(true), os.FileMode(fsm2.dbFileModeVal), testOpts)
...
//		internalBucket, err := tx.CreateBucketIfNotExists([]byte(fsm2.monotonicLogBucket))
//		if err != nil {
//			return err
//		}
//
...
//		return internalBucket.Put([]byte(fsm2.monotonicLogKey), val)
//	})
