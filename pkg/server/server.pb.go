...
var file_pkg_server_server_proto_rawDesc = []byte{
	...
	0x32, 0xe9, 0x04, 0x0a, 0x0e, 0x4b, 0x56, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x65, 0x72, 0x76,
	...
	0x6c, 0x79, 0x22, 0x00, 0x12, 0x5e, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x25, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x65, 0x73, 0x63,
	0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x70,
...
var file_pkg_server_server_proto_goTypes = []interface{}{
	...
	(*database.DeleteBucketRequest)(nil),         // 19: database.DeleteBucketRequest
	(*database.CreateBucketRequest)(nil),         // 20: database.CreateBucketRequest
	...
	(*database.DeleteBucketReply)(nil),           // 43: database.DeleteBucketReply
	(*database.CreateBucketReply)(nil),           // 44: database.CreateBucketReply
...
var file_pkg_server_server_proto_depIdxs = []int32{
	...
	19, // 20: server.KVStoreService.DeleteAccount:input_type -> database.DeleteBucketRequest
	20, // 21: server.KVStoreService.CreateBucket:input_type -> database.CreateBucketRequest
	19, // 22: server.KVStoreService.DeleteBucket:input_type -> database.DeleteBucketRequest
	21, // 23: server.KVStoreService.GetKey:input_type -> database.GetKeyRequest
	22, // 24: server.KVStoreService.PutKey:input_type -> database.PutKeyRequest
	23, // 25: server.KVStoreService.DeleteKey:input_type -> database.DeleteKeyRequest
	...
	43, // 46: server.KVStoreService.DeleteAccount:output_type -> database.DeleteBucketReply
	44, // 47: server.KVStoreService.CreateBucket:output_type -> database.CreateBucketReply
	43, // 48: server.KVStoreService.DeleteBucket:output_type -> database.DeleteBucketReply
	45, // 49: server.KVStoreService.GetKey:output_type -> database.GetKeyReply
	46, // 50: server.KVStoreService.PutKey:output_type -> database.PutKeyReply
	47, // 51: server.KVStoreService.DeleteKey:output_type -> database.DeleteKeyReply
