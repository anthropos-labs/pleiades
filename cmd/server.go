...
//
//When the HostConfig.ListenAddress field is empty, NodeHost listens on
...
//HostConfig.Gossip must be configured to control the behaviors of the
//gossip service.
//
//Note that once enabled, the AddressByNodeHostID setting can not be later
//disabled after restarts.
//
//Please see the godocs of the HostConfig.Gossip field for a detailed
...
//HostConfig.RaftAddress should be set to the current address that can be
...
//10.0.0.300:24000
//
//To use these machines, first enable the HostConfig.AddressByNodeHostID
...
//
//var (
//	cfg *configuration.HostConfig = &configuration.HostConfig{
//		DevMode:                       true,
//		DeploymentID:                  1,
