...
func (this *SessionPayload) EqualVT(that *SessionPayload) bool {
	...
	if this.Type == nil && that.Type != nil {
		...
		if !this.Type.(interface {
			EqualVT(isSessionPayload_Type) bool
		}).EqualVT(that.Type) {
			return false
		}
	}
...
func (this *SessionPayload_NewSessionRequest) EqualVT(thatIface isSessionPayload_Type) bool {
	that, ok := thatIface.(*SessionPayload_NewSessionRequest)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.NewSessionRequest, that.NewSessionRequest; p != q {
		if p == nil {
			p = &NewSessionRequest{}
		}
		if q == nil {
...
func (this *SessionPayload_NewSessionResponse) EqualVT(thatIface isSessionPayload_Type) bool {
	that, ok := thatIface.(*SessionPayload_NewSessionResponse)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.NewSessionResponse, that.NewSessionResponse; p != q {
		if p == nil {
			p = &NewSessionResponse{}
		}
		if q == nil {
			q = &NewSessionResponse{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *SessionPayload_CloseSessionRequest) EqualVT(thatIface isSessionPayload_Type) bool {
	that, ok := thatIface.(*SessionPayload_CloseSessionRequest)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.CloseSessionRequest, that.CloseSessionRequest; p != q {
		if p == nil {
			p = &CloseSessionRequest{}
		}
		if q == nil {
			q = &CloseSessionRequest{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *SessionPayload_CloseSessionResponse) EqualVT(thatIface isSessionPayload_Type) bool {
	that, ok := thatIface.(*SessionPayload_CloseSessionResponse)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.CloseSessionResponse, that.CloseSessionResponse; p != q {
		if p == nil {
			p = &CloseSessionResponse{}
		}
		if q == nil {
			q = &CloseSessionResponse{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *SessionPayload_Error) EqualVT(thatIface isSessionPayload_Type) bool {
	that, ok := thatIface.(*SessionPayload_Error)
	if !ok {
		return false
	}
	if this == that {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Type.(*SessionPayload_NewSessionRequest); ok {
				...
				m.Type = &SessionPayload_NewSessionRequest{NewSessionRequest: v}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			if oneof, ok := m.Type.(*SessionPayload_NewSessionResponse); ok {
				...
				m.Type = &SessionPayload_NewSessionResponse{NewSessionResponse: v}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			if oneof, ok := m.Type.(*SessionPayload_CloseSessionRequest); ok {
				...
				m.Type = &SessionPayload_CloseSessionRequest{CloseSessionRequest: v}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			if oneof, ok := m.Type.(*SessionPayload_CloseSessionResponse); ok {
				...
				m.Type = &SessionPayload_CloseSessionResponse{CloseSessionResponse: v}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			if oneof, ok := m.Type.(*SessionPayload_Error); ok {
				...
				m.Type = &SessionPayload_Error{Error: v}
			}
			iNdEx = postIndex
		case 6:
			if wireType != 0 {
