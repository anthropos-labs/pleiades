...
func ldflags() string {
	...
	sb.WriteString("-X '")
	sb.WriteString("a13s.io/pleiades/pkg.GoVersion=")
	...
	sb.WriteString("-X '")
	sb.WriteString("a13s.io/pleiades/pkg.BuildTime=")
	sb.WriteString(now)
	sb.WriteString("'")
	writeComma(&sb)
	...
	sb.WriteString("-X '")
	sb.WriteString("a13s.io/pleiades/pkg.Sha=")
	...
	sb.WriteString("-X '")
	sb.WriteString("a13s.io/pleiades/pkg.Dirty=")
